...
class FuzzyMatchTest extends TestCase
{
    ...
    public function it_should_work(): void
    {
        ...
        self::assertTrue($fuzzy1->matches($fuzzy1->normalize('нe прост0 фраза, а обман')));
        self::assertFalse($fuzzy1->matches($fuzzy1->normalize('просто азаза')));
        ...
        self::assertTrue($fuzzy2->matches($fuzzy2->normalize('_m_a_i_l.r_u')));

        $fuzzy3 = new FuzzyMatch('89025211120');
        self::assertTrue($fuzzy3->matches($fuzzy3->normalize('8(902)521-11-20')));
    }
